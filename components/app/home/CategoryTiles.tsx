...
export function CategoryTiles({
  ...
  return (
    <div className="relative">
      {/* Horizontal Scalling container */}
      <div className="flex gap-4 overflow-x-auto py-4 pl-8 pr-4 sm:pl-12 sm:pr-6 lg:pl-10 lg:pr-8 no-scrollbar">
        <Link
          href="/"
          className={`group relative flex-shrink-0 overflow-hidden rounded-xl transition-all duration-300 ${
            !activeCategory
              ? "ring-2 ring-green-500 ring-offset-2 dark:ring-offset-zinc-900"
