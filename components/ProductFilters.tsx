  ...
  const FilterLabel = ({
    ...
    <div className="mb-2 flex items-center justify-between">
      ...
      >
        {children}
        {isActive && (
          <Badge className="ml-2 h-5 bg-green-500 px-1.5 text-xs text-white hover:bg-green-500">
            Active
          </Badge>
        )}
      </span>
    ...
    <div className="space-y-6 rounded-lg border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-950">
      ...
      <div>
        ...
        <form onSubmit={handleSearchSubmit} className="flex gap-2">
          ...
          />
          <Button type="submit" className="bg-green-600" size="sm">
            Search
          </Button>
        </form>
      </div>
      ...
      <div>
        ...
        <Slider
          ...
          className={`mt-4 ${isPriceActive ? "[&_[role=slider]]:border-green-500 [&_[role=slider]]:ring-green-500" : ""}`}
        />
      </div>
      ...
      <div>
        <label className="flex cursor-pointer items-center gap-3">
          <input
            ...
            className="h-5 w-5 rounded border-zinc-300 text-green-500 focus:ring-green-500 dark:border-zinc-600 dark:bg-zinc-800"
          />
          <span
